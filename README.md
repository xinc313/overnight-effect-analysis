...
6. **TQQQ 与连败处理(第三个标签页)**:信号在 TQQQ 上同样成立(前夜跌后 21.5bp、t=3.56);连跌越深下一夜越强(连跌 3 夜后 QQQ +18.9bp、t=3.00);买入后开盘亏损时,扛到收盘没有期望补偿(日内 −5bp、t=−1.1),回测显示「开盘照卖、信号在就再进」的基准政策夏普最高,「亏后休息」最差。TQQQ 条件策略 16 年 ×18.4(含 1bp 成本),接近 QQQ 买入持有,但回撤 −48% vs −82%;注意 TQQQ 样本只含牛市。
